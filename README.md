...
**Full-Stack & Cross-Platform Developer** — writing (and rewriting) code for 10+ years.
I build UI that runs on iOS, Android, and Web without touching it twice.
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/malviys/malviys/output/github-contribution-grid-snake-dark.gif"/>
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/malviys/malviys/output/github-contribution-grid-snake.gif"/>
  <img alt="github contribution snake animation" src="https://raw.githubusercontent.com/malviys/malviys/output/github-contribution-grid-snake.gif"/>
</picture>
